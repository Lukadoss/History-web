...
(function ($) {
    ...
    $.fn.fileinputLocales['cz'] = {
        ...
        removeTitle: 'Odstranit vybrané soubory',
        cancelLabel: 'Storno',
        ...
        msgInvalidFileType: 'Neplatný typ souboru "{name}". Pouze soubory typu "{types}" jsou podporovány.',
        msgInvalidFileExtension: 'Neplatná přípona souboru "{name}". Pouze soubory s příponou "{extensions}" jsou podporovány.',
        msgUploadAborted: 'Nahrávání souboru bylo přerušeno',
        msgValidationError: 'Chyba ověření',
        msgLoading: 'Nahrávání souboru {index} z {files} &hellip;',
        msgProgress: 'Nahrávání souboru {index} z {files} - {name} - {percent}% dokončeno.',
        msgSelected: 'Vybrané {files}: {n}',
