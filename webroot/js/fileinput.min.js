...
!function (e) {
    ...
    i = ".fileinput", t = window.URL || window.webkitURL, a = function (e, i, t) {
        ...
        btnLink: T,
        btnBrowse: F
    }, Z = {generic: U, html: A, image: j, text: L, video: z, audio: O, flash: R, object: N, other: B}, H = ["image", "html", "text", "video", "audio", "flash", "object"], W = {
        image: {
            width: "auto",
            height: "160px"
        },
        ...
        constructor: q, _init: function (i) {
            ...
            r.formdata = new FormData, r._abort(n) || (e = function (e) {
                ...
                r._raise("filebatchpreupload", [i]),
                    r._setProgress(50), n.data = i, n.xhr = e, r._abort(n) && (e.abort(), r._setProgressCancelled())
            }, i = function (e, i, t) {
            ...
            i._getThumbs().each(function () {
                ...
                -1 !== l && (void 0 !== o ? (a[t] = o, r[t] = i._getFileName(o), n.attr({id: i.previewInitId + "-" + t, "data-fileindex": t}), t++) : n.attr({
                    id: "uploaded-" + Y(),
                    "data-fileindex": "-1"
                }))
